...
namespace Dreamwalker.Quest
{
    ...
    public class QuestMainController : MonoBehaviour
    {
        ...
        [Header("Camera")]
        [SerializeField] private UnityEngine.Object cameraCapture;
        ...
        private void Awake()
        {
            CameraCapture = cameraCapture as ICameraCapture;
        ...
        private IEnumerator Start()
        {
            ...
            if (autoConnect)
            {
                ...
                // Use ScopeApiClient Inspector settings as source of truth
                string serverUrl = apiClient.ServerUrl;
        ...
        private IEnumerator ConnectToServer(string serverUrl)
        {
            ...
            // Use ScopeApiClient Inspector settings as source of truth
            var settings = apiClient.ToStreamSettings();
